                ...
                <div class="fixed-table-toolbar">
                    <div class="bs-bars pull-left">
                        ...
                        <div class="btn-group hidden-xs" id="toolbar" role="group">
                            ...
                            <button class="btn btn-outline btn-danger btn-rounded" onclick="f()">
                                <i class="fa fa-trash-o"></i> js
                            </button>
                        </div>
                    </div>
                </div>
...
<div class="ui-layout-west">
    <div class="box-header">
        ...
        <div class="tools">
            ...
            <button type="button" class="btn btn-box-tool changeMenu" id="btnCollapse" title="折叠"
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $(data).each(function (index, item) {
                ...
                console.log("item.dictValue" + item.dictValue + "item.dictLabel" + item.dictLabel);
