...
$("#bootstrap-table").bootstrapTable({
    url: "data/postlist.json",      //请求后台的URL（*）
    method: 'GET',                      //请求方式（*）
...
function formatterOpt(value, row, index) {
    var actions = [];
    actions.push('<a class="btn btn-info btn-xs btnRefresh" href="javascript:void(0);" data-toggle="modal" data-target="#updateModal" onclick="editRoles()"><i class="fa fa-edit"></i>编辑</a>');
...
function editRoles(){
    layer.open({
        ...
        maxmin: true,
        area: ['800px', '90%'],
        content: 'admin/post/edit.html/' //iframe的url
    });
...
$("#newAdd").click(function () {
    layer.open({
        ...
        maxmin: true,
        area: ['800px', '90%'],
        content: 'admin/post/add.html/' //iframe的url
    });
