...
! function ($) {
    ...
    Markdown.prototype = {
        ...
        showEditor: function () {
            ...
            if (this.$editor == null) {
                ...
                if (container.is('textarea')) {
                    ...
                    // This is some arbitrary label that could be edited
                    textarea = $('<textarea/>', {
                        'class': 'md-input',
                        'val': currentContent
                    })
        ...
        parseContent: function () {
            var content,
                callbackContent = this.$options.onPreview(this) // Try to get the label from callback

            if (typeof callbackContent == 'string') {
                // Set the label based by callback label
            ...
            case 9: // tab
                ...
                if (nextTab = this.getNextTab(), nextTab != null) {
                    ...
                    if (cursor.start == cursor.end && cursor.end == this.getContent().length) {
                        // The cursor already reach the end of the label
                        blocked = false
